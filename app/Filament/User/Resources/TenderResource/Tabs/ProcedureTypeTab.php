...
class ProcedureTypeTab
{
    ...
    {
        return [
            Placeholder::make('')->label('')->columnSpan(5),
            ...
            Select::make('invitation_request_processing_state')
                ...
                ->columnSpan(4),
            Placeholder::make('')->visible(fn (callable $get) => !$get('invitation_request_check'))->columnSpan(8),
            ...
            Checkbox::make('reliance_admit_check')
                ...
                ->visible(fn (callable $get) => $get('open_procedure_check'))
                ->columnSpan(4),
            Placeholder::make('')->visible(fn (callable $get) => $get('open_procedure_check'))->columnSpan(4),
            ...
            TextInput::make('reliance_qualification')
                ...
                ->visible(fn (callable $get) => $get('reliance_require_check') || $get('reliance_admit_check'))
                ->columnSpan(8),
            Placeholder::make('')->visible(fn (callable $get) => $get('reliance_require_check') || $get('reliance_admit_check'))->columnSpan(4),
            ...
            TextInput::make('partnership_activities')
                ...
                ->visible(fn (callable $get) => $get('partnership_require_check'))
                ->columnSpan(8),
            Placeholder::make('')->visible(fn (callable $get) => $get('partnership_require_check'))->columnSpan(4),
            Placeholder::make('')->visible(fn (callable $get) => !$get('partnership_require_check'))->columnSpan(8),
